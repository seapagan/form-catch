...
@pytest.mark.skip(reason="tests incomplete")
class TestAuthManager:
    """Test the AuthManager class."""

    def test_encode_token(self, mock_user, mock_settings, mocker):
    ...
    def test_encode_refresh_token(self, mock_user, mock_settings):
    ...
    def test_encode_verify_token(self, mock_user, mock_settings):
    ...
    @pytest.mark.asyncio
    async def test_refresh(self, mock_user, mock_settings, mocker):
        """Test that a refresh token is generated with the correct payload."""
    ...
    @pytest.mark.asyncio
    async def test_refresh_invalid_token(self, mocker):
    ...
    @pytest.mark.asyncio
    async def test_refresh_expired_token(self, mocker):
